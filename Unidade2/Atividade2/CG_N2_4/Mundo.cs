...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            //Cor do Fundo
            GL.ClearColor(
              0.49803921568627450980392156862745f,
              0.49803921568627450980392156862745f,
              0.49803921568627450980392156862745f,
              1.0f
            );
            ...
            /*objetoNovo = new Circulo(null, 0.5, 72);
            ...
            objetoNovo.PrimitivaTamanho = 20;
            ObjetoNovo(objetoNovo); objetoNovo = null;*/
            #endregion
            ...
            Objeto objetoLinhas = new Retangulo(objetoNovo, new Ponto4D(-0.5, 0.5), new Ponto4D(0.5, -0.5));
            objetoLinhas.PrimitivaTipo = PrimitiveType.LineStrip;
            //ObjetoNovo(objetoLinhas);

            Objeto objetoFilho = new Spline(objetoNovo, 5);
            //ObjetoNovo(objetoFilho);

            ObjetoNovo(objetoNovo, objetoLinhas);
            ObjetoNovo(objetoNovo, objetoFilho);
            ObjetoNovo(objetoNovo);
            objetoNovo = null;
            #endregion

            #region Objeto: segmento de reta  
            /*objetoNovo = new SegReta(null, new Ponto4D(0, 0), Matematica.GerarPtosCirculo(angulo, raio));
            ObjetoNovo(objetoNovo); objetoNovo = null;*/
            #endregion
      ...
      Spline objSpline = objetoSelecionado as Spline;
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            else if (input.IsKeyPressed(Keys.P)) //Plus não funciona
            {   
                Spline objeto = (Spline)objetoSelecionado.objetosLista.Find(c => c is Spline);
                if(objeto != null){
                    objeto.AlterarNumeroArestas(1);
                }
            ...
            {
                objetoSelecionado.PontosAlterar(new Ponto4D(objetoSelecionado.PontosId(pontoControle).X, objetoSelecionado.PontosId(pontoControle).Y + 0.05, 0), pontoControle);
                objetoSelecionado.ObjetoAtualizar();
            }
            ...
            {
                objetoSelecionado.PontosAlterar(new Ponto4D(objetoSelecionado.PontosId(pontoControle).X - 0.05, objetoSelecionado.PontosId(pontoControle).Y, 0), pontoControle);
                objetoSelecionado.ObjetoAtualizar();
            }
