...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            objetoNovo.shaderCor = new Shader("Shaders/shader.vert", "Shaders/shaderMagenta.frag");
            ObjetoNovo(objetoNovo); objetoNovo = null;
            #endregion
                    ...
                    else
                    {
                        if (input.IsKeyPressed(Keys.Space))
                        {
                            ...
                            else
                            {
                                ...
                                var primitivaTipo = objetoSelecionado.PrimitivaTipo;

                                switch (objetoSelecionado.PrimitivaTipo)
                                {
                                    case PrimitiveType.Points:
                                        primitivaTipo = PrimitiveType.Lines; break;
                                    case PrimitiveType.Lines:
                                        primitivaTipo = PrimitiveType.LineLoop; break;
                                    case PrimitiveType.LineLoop:
                                        primitivaTipo = PrimitiveType.LineStrip; break;
                                    case PrimitiveType.LineStrip:
                                        primitivaTipo = PrimitiveType.Triangles; break;
                                    case PrimitiveType.Triangles:
                                        primitivaTipo = PrimitiveType.TriangleStrip; break;
                                    case PrimitiveType.TriangleStrip:
                                        primitivaTipo = PrimitiveType.TriangleFan; break;
                                    default:
                                        primitivaTipo = PrimitiveType.Points; break;
                                }
